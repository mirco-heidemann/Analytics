## ----
## Schadentrend Elementar-und Feuerschaeden aller der Aargauischen
## Gebäudeversicherung
...
## csv file agv einlesen
df <- read.csv2(paste0(pth_data, 'agv_jahreschadenstatistik_2017.csv'),
...
bar0 <- ggplot() +
  ...
  labs(title = "Entwicklung des Versicherungskapitals der AGV",
       subtitle = "", 
       caption = "Quelle: AGV") + 
...
bar1 <- ggplot() +
  ...
  labs(title = "Versicherungskapital und Jahresschäden der AGV", 
       subtitle = "", 
       caption = "Quelle: AGV") + 
  theme(plot.title = element_text(size = 14, colour = "black", vjust = 1, hjust = 0),
        axis.title.x = element_blank(),
...
bar2 <- ggplot() +
  ...
  # labs(title = "Trend der Feuer- und Elementarschäden aller 18 KGV (ohne Bern)",
  labs(title = "Trend der Feuer- und Elementarschäden der AGV nach Schadenjahr",
...
bar3 <- ggplot(df, aes(x = jahr, y = pm_fs_Z, label = pm_fs_Z)) + 
  ...
  ylab("") +
  labs(title = "Abweichung vom Jahresschadenmittel Feuer der AGV",
...
bar4 <- ggplot(df, aes(x = jahr, y = pm_es_Z, label = pm_es_Z)) + 
  ...
  ylab("") +
  labs(title ="Abweichung vom Jahresschadenmittel Elementar der AGV",
       subtitle = "Standardisierte Schäden im Verhältnis zum Versicherungskapital",
       caption = "Quelle: AGV") +
  theme(plot.title = element_text(size = 14, colour = "black", vjust = 1, hjust = 0),
        axis.title.x = element_blank(),
...
bar5 <- ggplot(df.Fs, aes(x = jahr, y = pm_fs_Z, label = pm_fs_Z)) + 
  ...
  scale_fill_manual(name = "Jahresschaden", 
                    ...
                    values = c("above" = "#de2d26", "below" = "#fcae91")) + 
  ylab("") + xlab("") +
  labs(title = "Sortierte Abweichung vom Jahresschadenmittel Feuer der AGV",
       subtitle = "Standardisierte Schäden im Verhältnis zum Versicherungskapital",
       caption = "Quelle: AGV") +
  coord_flip() +
  theme(plot.title = element_text(size = 14, colour = "black", vjust = 1, hjust = 0),
...
bar6 <- ggplot(df.Es, aes(x = jahr, y = pm_es_Z, label = pm_es_Z)) + 
  ...
  scale_fill_manual(name = "Jahresschaden", 
                    ...
                    values = c("above" = "#2171b5", "below" = "#9ecae1")) + 
  ylab("") + xlab("") +
  labs(title = "Sortierte Abweichung vom Jahresschadenmittel Elementar der AGV",
       subtitle = "Standardisierte Schäden im Verhältnis zum Versicherungskapital",
       caption = "Quelle: AGV") +
  coord_flip() +
  theme(plot.title = element_text(size = 14, colour = "black", vjust = 1, hjust = 0),
...
# ## save a png
# ggsave(bar1, filename = "irv.vs.schad.png", dpi = 1000, type = "cairo",
#        width = width.plot, height = height.plot, units = "in")
# 
# # -- bar2
...
#        width = width.plot, height = height.plot, units = "in")
# ## save a png
# ggsave(bar2, filename = "agv_trend.png", dpi = 1000, type = "cairo",
#        width = width.plot, height = height.plot, units = "in")
# 
# ## -- bar3
