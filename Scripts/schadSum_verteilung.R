...
## Schadendaten aus Gemdat aufbereiten und Schadensummenverteilung
## darstellen
...
df_select <- df %>% 
  filter(str_detect(schad_code,
         ...
         scha_dat >= as.Date("30.05.2018", "%d.%m.%Y") &
           scha_dat <= as.Date("31.05.2018", "%d.%m.%Y"),
         # gesmter bezirk dielsdorf:
         gemeinde == 'Weiach' | gemeinde == 'Stadel' | gemeinde == 'Bachs' |
           gemeinde == 'Neerach' | gemeinde == 'Niederglatt' |
           gemeinde == 'Oberglatt' | gemeinde == 'Rümlang' |
           gemeinde == 'Niederhasli'| gemeinde == 'Dielsdorf'| gemeinde == 'Steinmaur' |
           gemeinde == 'Schöfflisdorf' | gemeinde == 'Oberweningen' |
           gemeinde == 'Niederwenigen' | gemeinde == 'Schleinikon' |
           gemeinde == 'Regensberg' | gemeinde == 'Boppelsen' |
           gemeinde == 'Buchs' | gemeinde == 'Regensdorf' | gemeinde == 'Dällikon' |
           gemeinde == 'Dänikon' | gemeinde == 'Hüttikon' | gemeinde == 'Otelfingen',
         schad_sum > 0)
